...
export default function AIVideoGenerator() {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    setError('')
    setVideos([])
    setStatus('Analyzing story and generating scenes...')
    ...
    try {
      ...
      if (data.success) {
        ...
        setStatus('Videos generated successfully!')
      } else {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Generate short animated videos from your stories</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 h-fit">
          <form onSubmit={handleGenerate} className="space-y-6">
            ...
            >
              {loading ? 'Generating Videos...' : 'Generate 4 Animated Videos'}
            </button>
