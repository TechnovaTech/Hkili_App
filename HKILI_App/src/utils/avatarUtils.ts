...
// NOTE: React Native <Image> on Android cannot render .avif (and some .webp),
// so every avatar below is served as .jpg (converted copies live in the
// backend public/ folder). Do not reintroduce .avif/.webp paths here.
export const MALE_AVATARS = [
  ...
  { id: 'm3', gender: 'male', path: 'male/hand-drawn-profile-icon-avatar-character_884500-33561.jpg' },
  { id: 'm4', gender: 'male', path: 'male/hand-drawn-profile-icon-avatar-character_884500-34499.jpg' },
  { id: 'm5', gender: 'male', path: 'male/hand-drawn-profile-icon-avatar-character_884500-34686.jpg' },
  { id: 'm6', gender: 'male', path: 'male/hand-drawn-profile-icon-avatar-character_884500-34726.jpg' },
...
export const FEMALE_AVATARS = [
  ...
  { id: 'f5', gender: 'female', path: 'female/cute-cartoon-girl-avatar-long-brown-hair-friendly-expression-various-uses-showcasing-young-female-character-371428712.jpg' },
  { id: 'f6', gender: 'female', path: 'female/cute-girl-avatar-featuring-long-black-hair-styled-flat-design-smiling-wearing-shirt-embodying-youthful-371432328.jpg' },
  { id: 'f7', gender: 'female', path: 'female/generated-image-372601986.jpg' },
  { id: 'f8', gender: 'female', path: 'female/young-man-avatar-character-due-avatar-man-vector-icon-cartoon-illustration_1186924-4438.jpg' },
];
